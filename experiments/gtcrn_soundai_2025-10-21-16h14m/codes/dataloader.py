...
NOISY_DATABASE_TRAIN = os.path.join(_script_dir, 'prepare_datasets', 'soundai', 'train_noisy')
NOISY_DATABASE_VALID = os.path.join(_script_dir, 'prepare_datasets', 'soundai', 'dev_noisy')
