...
NOISY_DATABASE_TRAIN = os.path.join(_script_dir, 'prepare_datasets/soundai-splitted/train_noisy')
NOISY_DATABASE_VALID = os.path.join(_script_dir, 'prepare_datasets/soundai-splitted/dev_noisy')
